// HEADER
export const LOGIN_BTN = "Conectează-te";
export const REGISTER_BTN = "Înregistrează-te";
export const SEARCH_PLACEHOLDER = "Caută…";

// LOGIN
export const LOGIN_TITLE = "Conectează-te la contul tău";
...
export const FIRST_NAME = "Nume";
export const LAST_NAME = "Prenume";
export const PHONE = "Telefon";

// HOME
export const CAROUSEL_LEGEND_1 = 'Legend 1';
export const CAROUSEL_LEGEND_2 = 'Legend 2';
export const TAILOR_PROFILE_TITLE = 'Fă cunoștință cu specialistul nostru în croitorie.';
